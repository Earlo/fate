...
const CharacterButton: React.FC<CharacterButtonProps> = ({
  ...
  <div
    onClick={onClick}
    className="group flex h-24 w-64 cursor-pointer items-center space-x-4 rounded-lg border border-gray-300 pl-4 transition-colors duration-200 hover:bg-gray-200 hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-400 active:bg-gray-300"
  >
    <Image
